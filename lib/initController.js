      ...
      case 'mp4':
        {
          ...
          const unload = () => {
            if (mp4Loaded === false) {
              console.log('mp4 already unloaded', videoElement.id);

              return;
            }

            console.log('mp4 unload', videoElement.id);
          ...
          const load = () => {
            if (mp4Loaded === true) {
              console.log('mp4 already loaded', videoElement.id);

              return;
            }

            console.log('mp4 load', videoElement.id);
